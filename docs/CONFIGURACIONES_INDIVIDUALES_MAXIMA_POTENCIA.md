...
| **LR** | 2.0e-4 | Suave pero no demasiado (PPO tolera mejor) |
| **Clip Range** | 0.1 | MÁS restrictivo que estándar (0.2) = más estable |
...
| **N Steps** | 2048 | Recolecta MUCHAS experiencias en paralelo |
