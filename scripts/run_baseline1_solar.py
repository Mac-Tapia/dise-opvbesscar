...
================================================================================
Ejecuta simulación de baseline SIN control RL pero CON generación solar.

Este es el punto de referencia para medir mejoras de agentes RL.
- Mall: 100 kW constante
- EVs: 50 kW constante
- Solar: 4,050 kWp activo
- BESS: Desactivado
- Control RL: NO
...
Resultado esperado: ~190,000 kg CO₂/año
================================================================================
"""
...
def main():
    parser = argparse.ArgumentParser(description="Baseline 1: Con Solar (4,050 kWp)")
    parser.add_argument(
        "--config",
        type=str,
    ...
    logger.info("")
    logger.info("=" * 80)
    logger.info("  🔆 BASELINE 1: CON SOLAR (4,050 kWp)")
    logger.info("=" * 80)
    logger.info("")
    ...
    out_dir = rp.outputs_dir / "baselines" / "baseline1_with_solar"
    ...
    logger.info("  Iniciando simulación baseline (con solar)...")
    logger.info("")
    ...
    # Guardar resumen
    summary = {
        "baseline": "baseline1_with_solar",
        "description": "Baseline CON generación solar (4,050 kWp)",
    ...
    summary_path = out_dir / "baseline1_summary.json"
    summary_path.write_text(json.dumps(summary, indent=2, ensure_ascii=False), encoding="utf-8")

    # Mostrar resultados
    logger.info("")
    logger.info("=" * 80)
    logger.info("  ✅ BASELINE 1 COMPLETADO")
    logger.info("=" * 80)
    logger.info("")
