...
# -*- coding: utf-8 -*-
"""
Generate SAC KPI Dashboard matching PPO structure.
...
print("=" * 70)
print("🔴 SAC KPI DASHBOARD GENERATOR (Matching PPO Structure)")
print("=" * 70)
...
# Generate dashboard
print("\n📈 Generating 2x3 KPI Dashboard for SAC...")
...
if len(consumption) > 1 and consumption[0] > 0:
    ...
    ax.text(0.98, 0.02, f'{"↓" if improvement > 0 else "↑"} {abs(improvement):.1f}%',
...
title = 'CityLearn v2 - SAC Agent KPI Dashboard'
if improvements:
...
# Print summary
print("\n📊 SAC KPI Summary (15 episodes, 5,475 days):")
...
print("\n" + "=" * 70)
print("✅ SAC KPI DASHBOARD GENERATION COMPLETE")
print("=" * 70)
