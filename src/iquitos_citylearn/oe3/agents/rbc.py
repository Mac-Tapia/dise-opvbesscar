...
class BasicRBCAgent:
    ...
    2. BESS: Cargar con exceso solar, descargar en hora pico/alto precio
    3. Priorizar reducción de importación de red
    4. Distribuir carga entre chargers según estrategia configurada
    """
