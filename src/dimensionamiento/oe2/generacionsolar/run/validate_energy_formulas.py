...
def validate_energy_formula():
    ...
    print("=" * 80)
    print("VALIDACIÓN DE FÓRMULAS DE ENERGÍA FOTOVOLTAICA")
    print("=" * 80)
    print()
    ...
    print()
    print(f"Fórmula CORRECTA: E = P × dt / 1000")
    print(f"  E [kWh] = {power_w:,} × {dt_hours} / 1000")
    print(f"  E [kWh] = {energy_kwh_correct:,.2f} kWh ✓")
    print()
    print(f"Fórmula INCORRECTA: E = P / 1000 (ignora dt)")
    print(f"  E [kWh] = {power_w:,} / 1000")
    print(f"  E [kWh] = {energy_kwh_wrong:,.2f} kWh ❌")
    print()
    ...
    print(f"Fórmula CORRECTA: E = P × dt / 1000")
    print(f"  E [kWh] = {power_w:,} × {dt_hours} / 1000")
    print(f"  E [kWh] = {energy_kwh_correct:,.6f} kWh ✓")
    print()
    print(f"Fórmula INCORRECTA: E = P / 1000 (ignora dt)")
    print(f"  E [kWh] = {power_w:,} / 1000")
    print(f"  E [kWh] = {energy_kwh_wrong:,.6f} kWh ❌")
    ...
    print("TEST 3: Año completo (8,760 horas) - DATOS REALES")
    print("-" * 80)
    ...
    if csv_path.exists():
        ...
        print(f"Horas al año: 8,760")
        print()
        print(f"Energía DC anual: {annual_dc_kwh:,.0f} kWh")
        print(f"Energía AC anual (con pérdidas): {annual_ac_kwh:,.0f} kWh")
        print(f"Factor de capacidad: {capacity_factor*100:.1f}%")
        print()
        print(f"Validación de fórmula E = P × Δt:")
        print(f"  P máxima DC: {dc_power_kw.max():.1f} kW")
        print(f"  E máxima DC (1 h): {dc_power_kw.max() * 1.0:.1f} kWh")
    ...
    print("TEST 4: Análisis dimensional (verificar unidades)")
    print("-" * 80)
    print()
    print("Definición de Watt (potencia):")
    print("  1 W = 1 J/s (joules per second)")
    print()
    print("Fórmula: E [kWh] = P [W] × t [h] / 1000")
    print()
    print("Verificación dimensional:")
    print("  [kWh] = [W] × [h] / 1000")
    ...
    print("  [kWh] = [kWh] ✓")
    print()
    print("✓ TEST 4 PASSED (Dimensional analysis correct)")
    print()
    ...
    print()
    print("CONCLUSIÓN:")
    print("  La fórmula de energía en solar_pvlib.py es CORRECTA:")
