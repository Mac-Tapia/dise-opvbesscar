...
def run_bess_sizing(
    ...
    pv_timeseries_path = pv_profile_path.parent / "pv_generation_hourly_citylearn_v2.csv"
...
if __name__ == "__main__":
    ...
    # Archivos de entrada
    pv_profile_path = oe2_dir / "Generacionsolar" / "pv_generation_hourly_citylearn_v2.csv"
