...
try:
    ...
    print("\n📈 ARQUITECTURA INTEGRADA (v5.2):")
    print("  ✅ OE2 (Dimensionamiento): Completado")
    print("     - Chargers: 19 físicos × 2 tomas = 38 tomas (Modo 3 @ 7.4 kW)")
    print("     - Solar: 4,050 kWp")
    print("     - BESS: 940 kWh / 342 kW (exclusivo EV)")
    print("")
    print("  ✅ OE3 (Control RL): Dataset listo")
    print("     - Observación: 778-dim (con SOC dinámico)")
    print("     - Acción: 39-dim (1 BESS + 38 tomas)")
